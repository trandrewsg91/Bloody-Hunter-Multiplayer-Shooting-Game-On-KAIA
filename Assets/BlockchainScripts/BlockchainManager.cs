...
namespace Visyde
{
    public class BlockchainManager : MonoBehaviourPunCallbacks
    {
        ...
        private string contractFactoryAddress = "0xfdeFD3f37C570126Cfa4E5f2C0dc94d5b3c520BC";
        ...
        public async void BetMoney()
        {
            ...
            try
            {
                await ThirdwebManager.Instance.SDK.Wallet.Transfer(escrowContractAddress, "0.2");
